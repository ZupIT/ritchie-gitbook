...
For more information on how to manipulate [repositories](../../../geting-started/software-architecture-1/repository.md), check out the documentation here: Repository.
{% endhint %}
